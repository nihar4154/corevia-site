...
## Creating a fresh PR from latest `main`

Use this workflow if a previous PR was closed/deleted and you need a clean replacement:

```bash
git checkout main
git pull origin main
git checkout -b fresh-pr-main-sync
git push -u origin fresh-pr-main-sync
```

Then open a new PR from `fresh-pr-main-sync` into `main`.

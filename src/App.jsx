...
const SITE_LOGO_URL = `${SITE_URL}/corevia-logo.svg`;
...
export default function App() {
  ...
  useEffect(() => {
    ...
    setMetaTag({ property: 'og:locale', content: 'en_US' });
    ...
    setMetaTag({ property: 'og:image', content: SITE_LOGO_URL });
    setMetaTag({ property: 'og:image:alt', content: 'Corevia Systems brand logo' });
    ...
    setMetaTag({ name: 'twitter:image', content: SITE_LOGO_URL });
    setMetaTag({ name: 'twitter:image:alt', content: 'Corevia Systems brand logo' });
